 ...
 */
View.prototype.attachToDOM = function viewAttachToDOMPrototype(container, element) {
    if (this.$element) {
 ...
 */
View.prototype.updateState = function(url) {
    this.currentURL = url;
 ...
 * @return {View}
 */
View.prototype.on = function(events, selector, data, handler) {
    this.$element.on(events + '.view', selector, data, handler);
    return this;
};

View.prototype.one = function(events, selector, data, handler) {
 ...
 * @return {View}
 */
View.prototype.off = function(events, selector, data, handler) {
 ...
 * @return {View}
 */
View.prototype.trigger = function(events, extraParameters) {
...
View.prototype._extractTitle = function(data) {
    return $($.parseHTML(data)).filter('title').text();
};

View.prototype._extractAlternateURLs = function(data) {
 ...
 * reset on View.clean()
 */
View.prototype.update = function(data/*, url*/) {
    this.clean();
 ...
 */
View.prototype.onBeforeClean = function() {};
 ...
 */
View.prototype.scrollTo = function(y, animationDuration, options) {
