...
var Router = exports.Router = function () {
    ...
    _createClass(Router, [{
        ...
        value: function start() {
            var urlViews = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : ['contentView', 'readerView'];
            ...
            if (!history.state) {
                ...
                try {
                    for (var _iterator = urlViews[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                        var viewName = _step.value;

                        var view = this.viewManager.getView(viewName);
                        if (view !== undefined) {
