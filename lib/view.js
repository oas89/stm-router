...
var View = exports.View = function () {
    ...
    _createClass(View, [{
        ...
        value: function attachToDOM(container, element) {
             ...
             */
            this.$element = (0, _jquery2['default'])(element ? element : this.element);
            this.$container = (0, _jquery2['default'])(container ? container : this.container);
            if (!this.isEmpty() && !this.currentURL) {
                ...
                //     it?
                this.currentURL = (0, _util.getRelativeUrl)();
            }
        ...
        value: function _extractTitle(data) {
            return (0, _jquery2['default'])(_jquery2['default'].parseHTML(data)).filter('title').text();
        }
    }, {
        key: '_extractAlternateURLs',
        value: function _extractAlternateURLs(data) {
            return (0, _jquery2['default'])(_jquery2['default'].parseHTML(data)).filter('[rel="alternate"][hreflang]').map(function (i, item) {
                return { lang: (0, _jquery2['default'])(item).prop('hreflang'), url: (0, _jquery2['default'])(item).prop('href') };
            });
        }
        ...
        value: function render(data) {
            var $data = (0, _jquery2['default'])(_jquery2['default'].parseHTML(data));
        ...
        value: function scrollTo(y, animationDuration, options) {
            ...
            if (this.$container) {
                ...
                if (container.get(0) === document.body) {
                    container = (0, _jquery2['default'])('html,body');
                }
        ...
        key: 'reloadIsRequired',
        value: function reloadIsRequired(url, options) {
            return true;
        }
    }, {
        key: 'onRoute',
