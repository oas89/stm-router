 ...
 * Handler description
 */
Router.prototype.map = function(handler) {
 ...
 */
Router.prototype.navigate = function(state, url, title) {
 ...
 * XXX: Bad naming.
 */
Router.prototype.updateState = function(state, url, title) {
    url = url.replace(/\/+/g, '/');
 ...
 * @private
 */
Router.prototype._route = function(url, data, options, view) {
    var state,
        handler;
...
//Router.prototype._urlServerPart = function(url) {
 ...
 * @param {Object} options
 */
Router.prototype._load = function(url, options) {
 ...
 */
Router.prototype.handleURL = function(url, options) {
 ...
 */
Router.prototype.on = function(events, selector, data, handler) {
 ...
 * @param {function(!jQuery.event=)=} handler
 */
Router.prototype.one = function(events, selector, data, handler) {
 ...
 * @param {function(!jQuery.event=)=} handler
 */
Router.prototype.off = function(events, selector, data, handler) {
 ...
 * @param {Object} params
 */
Router.prototype.trigger = function(events, params) {
    $(this).trigger(events, params);
};

Router.prototype._fallback = function(options) {
